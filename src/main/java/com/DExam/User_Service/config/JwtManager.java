...
public class JwtManager {
    ...
    private static final String issuer = "dexam-issuer";
    ...
    public static String generateToken(String email, String role) {
        ...
        return Jwts.builder().setClaims(claims).setIssuer(issuer).setIssuedAt(new Date(System.currentTimeMillis())).setExpiration(exp)
